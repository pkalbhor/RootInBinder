//  ////////////////////////////////////////////////////////////////////////////////////////////
//  Description : It divides Canvas into two Pads and Plots two graph
//                Input accepted a two frames(RooPlot) or two histograms(TH). 
...
template <typename T> 
CustomRatioPlot<T>::CustomRatioPlot(T *f1, T *f2){
    Init(f1, f2);
}

template <class T>
CustomRatioPlot<T>::~CustomRatioPlot(){}

template <class T>
void CustomRatioPlot<T>::SetupPads(){
...
template <class T>
void CustomRatioPlot<T>::SetgStyles(){
...
template <class T>
void CustomRatioPlot<T>::SetPadMargins(){
...
template <class T>
void CustomRatioPlot<T>::Init(T *f1, T *f2){
    frame1=f1; frame2=f2;
    SetgStyles();
    SetupPads();
    SetPadMargins();
...
template <class T>
void CustomRatioPlot<T>::PostDrawDecoration(){
